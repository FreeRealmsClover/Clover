...
public class StoreBundleCategoryGroupDefinitionCollection : ObservableConcurrentDictionary<int, StoreBundleCategoryGroupDefinition>
{
    private readonly ILogger _logger;

    public StoreBundleCategoryGroupDefinitionCollection(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public bool Load(string filePath)
    {
        ...
        try
        {
            ...
            var entries = JsonSerializer.Deserialize<List<StoreBundleCategoryGroupDefinition>>(fileStream, jsonSerializerOptions);

...
public class StoreBundleCategoryNodeCollection : ObservableConcurrentDictionary<int, StoreBundleCategoryNode>
{
    private readonly ILogger _logger;

    public StoreBundleCategoryNodeCollection(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public bool Load(string filePath)
    {
        ...
        try
        {
            ...
            var entries = JsonSerializer.Deserialize<List<StoreBundleCategoryNode>>(fileStream, jsonSerializerOptions);

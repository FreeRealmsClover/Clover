...
public class StoreBundleGroupDefinitionCollection : ObservableConcurrentDictionary<int, StoreBundleGroupDefinition>
{
    private readonly ILogger _logger;

    public StoreBundleGroupDefinitionCollection(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public bool Load(string filePath)
    {
        ...
        try
        {
            ...
            var entries = JsonSerializer.Deserialize<List<StoreBundleGroupDefinition>>(fileStream, jsonSerializerOptions);

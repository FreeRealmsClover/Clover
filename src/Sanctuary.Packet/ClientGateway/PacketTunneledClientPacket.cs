...
public class PacketTunneledClientPacket : ISerializablePacket, IDeserializable<PacketTunneledClientPacket>
{
    ...
    public static bool TryDeserialize(ReadOnlySpan<byte> data, out PacketTunneledClientPacket value)
    {
        value = new PacketTunneledClientPacket();
